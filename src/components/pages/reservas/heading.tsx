...
export default function HeadingReserva () {
  return (
    <div className="border-l-4 border-l-primary-1 container wrapper flex justify-between">
      <Heading heading="TUS RESERVAS :)" headingType="h1" className="max-w-96" />
      ...
      <div className="relative w-1/2 rounded-r-md overflow-hidden
        ...
        <img src={ReservaImg} alt="main image" className="absolute inset-0 size-full object-cover" />
      </div>
    </div>
  )
}